    ...
    public partial class bebidas : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if ((int)comboBox1.SelectedItem != 0)
            {
                ...
                pedidoController.agregarItemMenu(comidas[6], num1);
            }

            if ((int)comboBox2.SelectedItem != 0)
            {
                int num2 = (int)comboBox2.SelectedItem;
                pedidoController.agregarItemMenu(comidas[7], num2);
            }

            if ((int)comboBox3.SelectedItem != 0)
            {
                int num3 = (int)comboBox3.SelectedItem;
                pedidoController.agregarItemMenu(comidas[8], num3);
            }
